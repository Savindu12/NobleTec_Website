  ...
  return (
    ...
    <div  className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div data-aos="fade-up" className="lg:text-center">
        <h2  className="text-6xl text-amber-500 font-semibold tracking-wide uppercase">About Us</h2>
        ...
        <p className="mt-8 max-w-7xl text-3xl text-gray-500 lg:mx-auto">
          ...
          {features.map((feature) => (
            <div key={feature.name} className="relative">
              <dt>
                ...
                <p className="ml-16 text-4xl leading-6 font-medium text-gray-900">{feature.name}</p>
              </dt>
